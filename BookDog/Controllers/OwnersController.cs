...
namespace BookDog.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumer,Mail")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumer,Mail")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
