...
namespace BookDog.Controllers
{
    public class OffersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Offer.Include(o => o.Owner);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price,OwnerId,IsAvailable,Rate,Link")] Offer offer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price,OwnerId,IsAvailable,Rate,Link")] Offer offer)
        {
            if (id != offer.Id)
            {
                return NotFound();
